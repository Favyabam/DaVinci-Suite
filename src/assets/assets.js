...
export const cities = ["Abuja", "Jos", "Calabar", "Lagos"];
...
export const testimonials = [
  {
    ...
    review:
      "I've used many booking platforms before, but none compare to the personalized experience and attention to detail that DaVinci suits provides.",
  },
  {
    id: 2,
    name: "Nedum O",
    ...
    review:
      "DaVinci suits exceeded my expectations. The booking process was seamless, and the hotels were absolutely top-notch. Highly recommended!",
  },
  {
    id: 3,
    name: "Emeka I",
    ...
    review:
      "Amazing service! I always find the best luxury accommodations through DaVinci. Their recommendations never disappoint!",
  },
];
...
export const hotelDummyData = {
  ...
  name: "Urbanz Suites",
  address: "Main Road  143 Street , Calabar",
  contact: "+2348156475436",
  owner: userDummyData,
  city: "Calabar",
