    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                ...
                <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                    {room?.images.length > 1 && room.images.map((image, index) => (
                        <img onClick={() => setMainImage(image)}
                            ...
                            className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image && 'outline-3 outline-blue-500'}`} />
                    ))}
                </div>
            </div>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Guest would be allocated rooms according to availability, you get a comfortable room that has the best feeling. Ensure to please indicate the mumber of guest at the guest slot when booking so as to get the exact price, and allocation would be on a first come-first serve basis.</p>
            </div>
