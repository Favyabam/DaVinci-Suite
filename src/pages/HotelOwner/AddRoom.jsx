...
const AddRoom = () => {
    ...
    return (
        <form>
            <Title align='left' font='outfit' title='Add Room' subTitle='fill in the details carefully and accurate room details, pricing, and amenities, for a better booking experience.' />
